...
class RestaurantOrderManagement:
    def __init__(self, root):
        ...
        ttk.Label(frame, text="Currency:", font=("Arial", 12)).grid(row=len(self.menu_items) + 1, column=00, padx=10, pady=5)
    ...
    def setup_background(self, root):
            ...
            canvas.pack()
            original_image = tk.PhotoImage(file="Restaurent background.png")
                ...
                if quantity.isdigit():
                    ...
                    if quantity > 0:
                        ...
                        if total_cost > 0:
                            ...
                            messagebox.showinfo("Order Place, order_summary")
                        else:
